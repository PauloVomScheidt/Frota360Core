...
namespace Frota360.Application.Validators.Motorista
{
    public class UpdateMotoristaValidator : AbstractValidator<UpdateMotoristaRequest>
    {
        public UpdateMotoristaValidator()
        {
            RuleFor(x => x.Nome)
