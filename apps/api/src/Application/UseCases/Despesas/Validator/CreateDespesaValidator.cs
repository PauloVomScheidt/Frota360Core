...
{
    public class CreateDespesaValidator : AbstractValidator<CreateDespesaRequest>
    {
        public CreateDespesaValidator()
        {
            ...
            // Um dia de folga cobre fuso e relógio adiantado sem liberar lançamento futuro.
